...
from object_detection_m_1 import eval_util
from object_detection_m_1 import exporter as exporter_lib
from object_detection_m_1 import inputs
from object_detection_m_1.builders import graph_rewriter_builder
from object_detection_m_1.builders import model_builder
from object_detection_m_1.builders import optimizer_builder
...
from object_detection_m_1.utils import variables_helper
from object_detection_m_1.utils import visualization_utils as vis_utils
...
def create_train_and_eval_specs(train_input_fn,
  ...
  if eval_on_train_data:
    eval_specs.append(
        tf.estimator.EvalSpec(
            name='eval_on_train', input_fn=eval_on_train_input_fn, steps=None, throttle_secs=throttle_secs))
