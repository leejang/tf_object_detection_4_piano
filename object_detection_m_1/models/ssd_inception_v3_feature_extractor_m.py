...
from object_detection_m_1.models import feature_map_generators
...
class SSDInceptionV3FeatureExtractorM(ssd_meta_arch.SSDFeatureExtractor):
  ...
  def __init__(self,
    ...
    """
    super(SSDInceptionV3FeatureExtractorM, self).__init__(
