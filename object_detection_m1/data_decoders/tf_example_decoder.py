...
from object_detection_m3.core import data_decoder
from object_detection_m3.core import standard_fields as fields
from object_detection_m3.protos import input_reader_pb2
...
class TfExampleDecoder(data_decoder.DataDecoder):
  ...
  def __init__(self,
    ...
    if dct_method:
      ...
      audio = slim_example_decoder.Image(
          image_key='audio/encoded',
          format_key='audio/format',
          channels=3,
          dct_method=dct_method)
      flow = slim_example_decoder.Image(
          image_key='flow/encoded',
          format_key='flow/format',
          channels=3,
          dct_method=dct_method)
      # 1 frame before (previous frame)
      image_1 = slim_example_decoder.Image(
          image_key='image_1/encoded',
          format_key='image_1/format',
          channels=3,
          dct_method=dct_method)
      flow_1 = slim_example_decoder.Image(
          image_key='flow_1/encoded',
          format_key='flow_1/format',
          channels=3,
          dct_method=dct_method)
      # 2 frames before
      image_2 = slim_example_decoder.Image(
          image_key='image_2/encoded',
          format_key='image_2/format',
          channels=3,
          dct_method=dct_method)
      flow_2 = slim_example_decoder.Image(
          image_key='flow_2/encoded',
          format_key='flow_2/format',
          channels=3,
          dct_method=dct_method)
      ...
      flow = slim_example_decoder.Image(
          image_key='flow/encoded', format_key='flow/format', channels=3)
      # 1 frame before (previous frame)
      image_1 = slim_example_decoder.Image(
          image_key='image_1/encoded', format_key='image_1/format', channels=3)
      flow_1 = slim_example_decoder.Image(
          image_key='flow_1/encoded', format_key='flow_1/format', channels=3)
      # 2 frames before
      image_2 = slim_example_decoder.Image(
          image_key='image_2/encoded', format_key='image_2/format', channels=3)
      flow_2 = slim_example_decoder.Image(
          image_key='flow_2/encoded', format_key='flow_2/format', channels=3)
      additional_channel_image = slim_example_decoder.Image(
          image_key='image/additional_channels/encoded',
          format_key='image/format',
          channels=1,
