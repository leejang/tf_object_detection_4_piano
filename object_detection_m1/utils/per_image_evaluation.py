...
class PerImageEvaluation(object):
  ...
  def __init__(self,
    ...
    # for evaluation of the piano project
    # since we do not care about the location
    # for detecting pressed keys and fingers
    self.matching_iou_threshold = 0.1
  ...
  def compute_tp_fp(
    ...
    if (self.num_groundtruth_classes != 28):
      ...
      if len(note_result_scores) and len(oct_result_scores):
        ...
        print note_result_scores
        print oct_result_scores
        print max(note_result_scores)
        print max(oct_result_scores)
        print note_idx
        print oct_idx
        print note_result_tp_fp_labels
        print oct_result_tp_fp_labels
