...
from object_detection_m3 import eval_util
from object_detection_m3 import exporter as exporter_lib
from object_detection_m3 import inputs
from object_detection_m3.builders import graph_rewriter_builder
from object_detection_m3.builders import model_builder
from object_detection_m3.builders import optimizer_builder
...
from object_detection_m3.utils import variables_helper
from object_detection_m3.utils import visualization_utils as vis_utils
...
def create_model_fn(detection_model_fn, configs, hparams, use_tpu=False):
  ...
  def model_fn(features, labels, mode, params=None):
    ...
    audios = features[fields.InputDataFields.audio]
    preprocessed_flows = features[fields.InputDataFields.flow]

    preprocessed_images_1 = features[fields.InputDataFields.image_1]
    preprocessed_flows_1 = features[fields.InputDataFields.flow_1]
    preprocessed_images_2 = features[fields.InputDataFields.image_2]
    preprocessed_flows_2 = features[fields.InputDataFields.flow_2]
...
def create_train_and_eval_specs(train_input_fn,
  ...
  # two hours (60*60*2)
  #throttle_secs=7200
  #start_delay_secs=7200
  # twenty-four hours (60*60*24)
  #throttle_secs=600
  ...
  if eval_on_train_data:
    eval_specs.append(
        tf.estimator.EvalSpec(
            name='eval_on_train', input_fn=eval_on_train_input_fn, steps=None, start_delay_secs=start_delay_secs, throttle_secs=throttle_secs))
