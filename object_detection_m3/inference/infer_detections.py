...
from object_detection_m3.inference import detection_inference
...
def main(_):
  ...
  with tf.Session(config=session_config) as sess:
    ...
    serialized_example_tensor, image_tensor, audio_tensor, flow_tensor, image_tensor_1, flow_tensor_1, image_tensor_2, flow_tensor_2 = detection_inference.build_input(
        input_tfrecord_paths)
    tf.logging.info('Reading graph and building model...')
    (detected_boxes_tensor, detected_scores_tensor,
     detected_labels_tensor) = detection_inference.build_inference_graph(
         image_tensor, audio_tensor, flow_tensor, image_tensor_1, flow_tensor_1,
         image_tensor_2, flow_tensor_2, FLAGS.inference_graph)
