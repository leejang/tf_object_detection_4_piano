...
from object_detection_m3.core import standard_fields
...
def build_input(tfrecord_paths):
  ...
  features = tf.parse_single_example(
      ...
      features={
          ...
          standard_fields.TfExampleFields.audio_encoded:
              tf.FixedLenFeature([], tf.string),
          standard_fields.TfExampleFields.flow_encoded:
              tf.FixedLenFeature([], tf.string),
          standard_fields.TfExampleFields.image_encoded_1:
              tf.FixedLenFeature([], tf.string),
          standard_fields.TfExampleFields.flow_encoded_1:
              tf.FixedLenFeature([], tf.string),
          standard_fields.TfExampleFields.image_encoded_2:
              tf.FixedLenFeature([], tf.string),
          standard_fields.TfExampleFields.flow_encoded_2:
              tf.FixedLenFeature([], tf.string),
      })
  ...
  encoded_audio = features[standard_fields.TfExampleFields.audio_encoded]
  audio_tensor = tf.image.decode_image(encoded_audio, channels=3)
  audio_tensor.set_shape([None, None, 3])
  audio_tensor = tf.expand_dims(audio_tensor, 0)

  encoded_flow = features[standard_fields.TfExampleFields.flow_encoded]
  flow_tensor = tf.image.decode_image(encoded_flow, channels=3)
  flow_tensor.set_shape([None, None, 3])
  flow_tensor = tf.expand_dims(flow_tensor, 0)

  encoded_image_1 = features[standard_fields.TfExampleFields.image_encoded_1]
  image_tensor_1 = tf.image.decode_image(encoded_image_1, channels=3)
  image_tensor_1.set_shape([None, None, 3])
  image_tensor_1 = tf.expand_dims(image_tensor_1, 0)

  encoded_flow_1 = features[standard_fields.TfExampleFields.flow_encoded_1]
  flow_tensor_1 = tf.image.decode_image(encoded_flow_1, channels=3)
  flow_tensor_1.set_shape([None, None, 3])
  flow_tensor_1 = tf.expand_dims(flow_tensor_1, 0)

  encoded_image_2 = features[standard_fields.TfExampleFields.image_encoded_2]
  image_tensor_2 = tf.image.decode_image(encoded_image_2, channels=3)
  image_tensor_2.set_shape([None, None, 3])
  image_tensor_2 = tf.expand_dims(image_tensor_2, 0)

  encoded_flow_2 = features[standard_fields.TfExampleFields.flow_encoded_2]
  flow_tensor_2 = tf.image.decode_image(encoded_flow_2, channels=3)
  flow_tensor_2.set_shape([None, None, 3])
  flow_tensor_2 = tf.expand_dims(flow_tensor_2, 0)

  return serialized_example_tensor, image_tensor, audio_tensor, flow_tensor, image_tensor_1, flow_tensor_1, image_tensor_2, flow_tensor_2


def build_inference_graph(image_tensor, audio_tensor, flow_tensor,
                          image_tensor_1, flow_tensor_1, image_tensor_2, flow_tensor_2,
  ...
  tf.import_graph_def(
      graph_def, name='', input_map={'image_tensor': image_tensor, 'image_tensor_1': audio_tensor,
                                     'image_tensor_2': flow_tensor, 'image_tensor_3': image_tensor_1,
                                     'image_tensor_4': flow_tensor_1, 'image_tensor_5': image_tensor_2,
                                     'image_tensor_6': flow_tensor_2})
