...
from object_detection_m3.builders import graph_rewriter_builder
...
def _get_outputs_from_inputs(input_tensors, audio_tensors, flow_tensors,
                             input_tensors_1, flow_tensors_1,
                             input_tensors_2, flow_tensors_2,
                             detection_model,
  ...
  # audio
  audios = tf.to_float(audio_tensors)
  # flow
  flows = tf.to_float(flow_tensors)
  preprocessed_flows, true_image_shapes = detection_model.preprocess(flows)

  inputs_1 = tf.to_float(input_tensors_1)
  preprocessed_inputs_1, true_image_shapes = detection_model.preprocess(inputs_1)
  flows_1 = tf.to_float(flow_tensors_1)
  preprocessed_flows_1, true_image_shapes = detection_model.preprocess(flows_1)

  inputs_2 = tf.to_float(input_tensors_2)
  preprocessed_inputs_2, true_image_shapes = detection_model.preprocess(inputs_2)
  flows_2 = tf.to_float(flow_tensors_2)
  preprocessed_flows_2, true_image_shapes = detection_model.preprocess(flows_2)

  output_tensors = detection_model.predict(
      preprocessed_inputs, true_image_shapes,
      audios,
      preprocessed_flows,
      preprocessed_inputs_1,
      preprocessed_flows_1,
      preprocessed_inputs_2,
      preprocessed_flows_2)
...
def _build_detection_graph(input_type, detection_model, input_shape,
  ...
  placeholder_audio_tensor, audio_tensors = input_placeholder_fn_map[input_type](
      **placeholder_args)
  placeholder_flow_tensor, flow_tensors = input_placeholder_fn_map[input_type](
      **placeholder_args)

  placeholder_tensor_1, input_tensors_1 = input_placeholder_fn_map[input_type](
      **placeholder_args)
  placeholder_flow_tensor_1, flow_tensors_1 = input_placeholder_fn_map[input_type](
      **placeholder_args)
  placeholder_tensor_2, input_tensors_2 = input_placeholder_fn_map[input_type](
      **placeholder_args)
  placeholder_flow_tensor_2, flow_tensors_2 = input_placeholder_fn_map[input_type](
      **placeholder_args)
  ...
  outputs = _get_outputs_from_inputs(
      ...
      input_tensors_1=input_tensors_1,
      flow_tensors_1=flow_tensors_1,
      input_tensors_2=input_tensors_2,
      flow_tensors_2=flow_tensors_2,
