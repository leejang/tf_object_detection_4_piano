...
from nets import inception_v3_m2

slim = tf.contrib.slim


class SSDInceptionV3FeatureExtractorM2(ssd_meta_arch.SSDFeatureExtractor):
  ...
  def __init__(self,
    ...
    """
    super(SSDInceptionV3FeatureExtractorM2, self).__init__(
